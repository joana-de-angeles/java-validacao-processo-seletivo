...
public class ControleCandidatos {
    public static void main(String[] args) {
        String[] candidatos = {"Felipe", "Marcia", "Julia", "Paulo", "Gabriela"};
    ...
    static void entrandoEmContato(String candidato){
        ...
        }while(continuaTentando && tentativasRealizadas < 5);
    ...
    static void selecaoCandidatos(){
        String[] candidatos = {"Felipe", "Marcia", "Julia", "Paulo", "Gabriela", "Mônica", "Gabriela", "Carol", "João", "Samuel"};
